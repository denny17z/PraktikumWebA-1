...
<div class="container">
  ...
  <table class="table">
    ...
    <?php
        ...
        $result = $konek->query("SELECT * FROM tb_pagination");
        $total_records = mysqli_num_rows($result);
        $total_no_page = ceil($total_records/$total_data_page);
        $second_last = $total_no_page - 1;
        $resultPerPage = $konek->query("SELECT * FROM tb_pagination
  ...
  <br>
  <a href="insert.php"><button type="button" class="btn btn-primary">Insert Data</button></a>
</div>
</body>
</html>